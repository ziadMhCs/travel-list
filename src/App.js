...
const initialquantity = [
  ...
  { id: 7, description: "Snacks", quantity: "Assorted", packed: true },
  { id: 8, description: "Guidebook", quantity: 1, packed: false },
  { id: 9, description: "Jacket", quantity: 1, packed: false },
  { id: 10, description: "Sunglasses", quantity: 1, packed: true },
];
function App() {
  ...
  function handelDeleteItem(id) {
    // console.log(e);
    setItems((items) => items.filter((someItem) => id !== someItem.id));
  }
...
function PackingList({ items, onDeleteItem, onToggleItems, onClearList }) {
  ...
  switch (sortBy) {
    ...
    default:
      console.log(
        "softing functionality Error occured , you should not reach this code !!"
      );
  }
  ...
  return (
    <footer className="stats">
      {numberOfitems === numberOfpackedItems
        ...
        : `🧳you have ${numberOfitems} items on your list, and you already packed ${numberOfpackedItems} items!
  (${percentage}%)`}
    </footer>
  );
}
